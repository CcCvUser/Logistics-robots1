...
#define DIR_OUT()       gpio_dir_old (SEEKFREE_SDA, GPO)    //输出方向
#define DIR_IN()        gpio_dir_old (SEEKFREE_SDA, GPI)    //输入方向
...
{
	gpio_init (SEEKFREE_SCL, GPO,1,SPEED_100MHZ | DSE_R0 | PULLUP_47K | PULL_EN | OD_EN);
	gpio_init (SEEKFREE_SDA, GPO,1,SPEED_100MHZ | DSE_R0 | PULLUP_47K | PULL_EN | OD_EN);
}
